var themhuycthdvatControl = {
    init: function () {

        themhuycthdvatControl.registerEvent();

    },

    registerEvent: function () {

        $('#frmThemhuycthdvat').validate({
            rules: {
                stt: {
                    required: true
                }
        ...
        $('#btThemhuycthdvat').on('click', function () {
            
            themhuycthdvatControl.exportList();
        });
    },
    exportList: function () {
